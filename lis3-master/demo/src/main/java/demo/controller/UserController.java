...
//	    		this.userRepository.save(user);
    ...
    public void editprofile(@RequestBody User u)
    {
    	User p=(this.userRepository.findById(u.getTechnician_id())).get();
    	p.setRole_admin(u.getRole_admin());
    	p.setRole_analyzing(u.getRole_analyzing());
    	p.setRole_doctor(u.getRole_doctor());
    	p.setRole_grossing(u.getRole_grossing());
    	p.setRole_reception(u.getRole_reception());
    	p.setRole_reporting(u.getRole_reporting());
    	p.setTechnician_age(u.getTechnician_age());
    	p.setTechnician_contactnumber(u.getTechnician_contactnumber());
    	p.setTechnician_email(u.getTechnician_email());
    	p.setTechnician_gender(u.getTechnician_gender());
